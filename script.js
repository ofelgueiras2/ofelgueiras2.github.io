   ...
   .filter(t => t !== null);
    ...
    function calcularPreco(tarifarios, consumo, potenciaSelecionada) {
        ...
        tarifarios.forEach((tarifa, index) => {
            ...
            let cellAttrs = '';
            if ((tarifa.nome === "EDP indexado" || tarifa.nome.startsWith("EDP: Indexado")) && incluirEDP && potenciaNum >=3.45) {
            ...
            if ((tarifa.nome.startsWith("G9: Net") || tarifa.nome.startsWith("G9 Net"))) {
